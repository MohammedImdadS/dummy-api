...
header_dic = {"app-id": "62638dbd4862e5a1081b1dbf"}
...
def fetch_user_data():
    ...
    try:
        ...
        table_name = "user"
        file_name = "C://Users//Muhammed Imdad//Desktop//Project//TailNode//part_A//create_user_table.pgsql" # change location accordings to file location
...
def fetch_user_postdata():
    ...
    table2 = "post"
    primarykey="id"
    file_name = "C://Users//Muhammed Imdad//Desktop//Project//TailNode//part_A//create_post_table.pgsql" # change location accordings to file location
